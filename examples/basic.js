...
client.on("ready", () => { // Executes this function when the client is ready
    console.log("Client online!"); // Logs "Client online!"
});

client.on("message_create", (message) => { // Executes this function when the client receives a message
